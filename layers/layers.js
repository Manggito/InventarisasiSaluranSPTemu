...
lyr_GoogleSatelliteHybrid_0.setVisible(false);lyr_GoogleSatellite_1.setVisible(true);lyr_GoogleRoads_2.setVisible(false);lyr_OpenTopoMap_3.setVisible(false);lyr_Sungai_4.setVisible(true);lyr_Jalan_5.setVisible(true);lyr_LuasFungsional_6.setVisible(true);lyr_KETERANGANKERUSAKANSALURAN_7.setVisible(true);lyr_SaluranSekunder_8.setVisible(true);lyr_SaluranPrimer_9.setVisible(true);lyr_AREA_NOMENKLATUR_10.setVisible(true);lyr_BANGUNAN_NOMENKLATUR_11.setVisible(true);lyr_Tikungan_12.setVisible(true);lyr_Beda_Pasangan_13.setVisible(true);lyr_Gorong__Gorong_14.setVisible(true);lyr_TitikPer50m_15.setVisible(true);lyr_Bangunan_Air_16.setVisible(true);lyr_Bangunan_Bagi_17.setVisible(true);lyr_Bangunan_Sadap_18.setVisible(true);lyr_Sumur_Pompa_19.setVisible(true);lyr_Rumah_Pompa_20.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_GoogleSatellite_1,lyr_GoogleRoads_2,lyr_OpenTopoMap_3,lyr_Sungai_4,lyr_Jalan_5,lyr_LuasFungsional_6,lyr_KETERANGANKERUSAKANSALURAN_7,group_JENISSALURAN,group_SKEMANOMENKLATUR,group_TITIKKETERANGAN,group_TITIKAKSESSORIS];
...
lyr_LuasFungsional_6.set('fieldAliases', {'Id': 'Id', 'NAMA_AREA': 'NAMA_AREA', 'LUAS': 'LUAS', });
...
lyr_LuasFungsional_6.set('fieldImages', {'Id': 'Range', 'NAMA_AREA': 'TextEdit', 'LUAS': 'TextEdit', });
...
lyr_LuasFungsional_6.set('fieldLabels', {'Id': 'hidden field', 'NAMA_AREA': 'inline label - visible with data', 'LUAS': 'inline label - visible with data', });
